...
st.caption("Annual average PUE and WUE by county. AE = Air Economizer, WEC = Water Economizer. For cost estimates including drought surcharges, see Pricing Estimation.")

# Tabs: PUE | WUE
tab_pue, tab_wue = st.tabs(["PUE comparison", "WUE comparison"])
